...
//		Restaurant restaurant=Restaurant.of().restaurantName("Almas").rating(3).contactNo("9059798193").emailId("almas.resturant@gmail.com").build();
//		session.persist(restaurant);
//		System.out.println("Resturant id: "+restaurant.getRestaurantId());
//		
